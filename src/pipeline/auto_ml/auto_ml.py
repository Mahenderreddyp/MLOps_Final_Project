...
automl_run_id = 'good_flag_ff2vkzp77x_20'
...
def generate_data_transformation_config():
    ...
    column_group_3 = [['Birth Weight']]
    
    column_group_5 = ['CCSR Diagnosis Code', 'CCSR Diagnosis Description', 'CCSR Procedure Code', 'CCSR Procedure Description', 'APR DRG Description']
    
    column_group_2 = [['Operating Certificate Number'], ['Permanent Facility Id'], ['Length of Stay'], ['APR DRG Code'], ['Birth Weight']]
    
    column_group_4 = ['Facility Name']
    
    column_group_1 = ['Emergency Department Indicator']
    
    column_group_0 = ['Health Service Area', 'Hospital County', 'Age Group', 'Zip Code', 'Gender', 'Race', 'Ethnicity', 'Type of Admission', 'Patient Disposition', 'APR MDC Code', 'APR MDC Description', 'APR Severity of Illness Code', 'APR Severity of Illness Description', 'APR Risk of Mortality', 'APR Medical Surgical Description', 'Payment Typology 1', 'Payment Typology 2', 'Payment Typology 3']
...
def generate_algorithm_config():
    ...
    algorithm = PreFittedSoftVotingRegressor(
        ...
        weights=[0.5384615384615384, 0.46153846153846156]
    )
...
def main(training_dataset_uri=None):
    ...
    cv_splits = _CVSplits(X, y, frac_valid=None, CV=2, n_step=None, is_time_series=False, task='regression')
    scores = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/eastus2/workspaces/792d70be-31ff-49d0-af21-afeb3a5cf42c/data/sparcs_raw_table/versions/1',     help='Default training dataset uri is populated from the parent run')
